...
// example  SML power meter + gas counter
#if METER==COMBO_DIC
#undef METERS_USED
#define METERS_USED 2
struct METER_DESC const meter_desc[METERS_USED]={
  [0]={3,'s',0,SML_BAUDRATE,"SML",-1,1,0}, // harware serial RX pin
...
//0x77,0x07,0x01,0x00,0x00,0x00,0x09,0xff
"1,77070100000009ff@#," D_METERNR ",," DJ_METERNR ",0|"
// with counters the comparison string must be exactly this string  //DIC: div by @1000
"2,1-0:1.8.0*255(@1000," D_GasIN ",cbm," DJ_COUNTER ",2";
#endif

// example  SML power meter + gas counter
#if METER==GASONLY_DIC
#undef METERS_USED
#define METERS_USED 1
struct METER_DESC const meter_desc[METERS_USED]={
  [0]={14,'c',0,50,"Gas"}}; // GPIO14 gas counter
// 2 meters defined
const uint8_t meter[]=
// with counters the comparison string must be exactly this string  //DIC: div by @1000
"2,1-0:1.8.0*255(@1000," D_GasIN ",cbm," DJ_COUNTER ",2";
